...
test.setTimeout(1020000); // 17 minutes
  ...
  const subCategories = [ 
    ...
    { name: 'Daily Good Rice', clickMethod: homePage.gotolink.bind(homePage, "https://www.zepto.com/search?query=daily+good+rice") },
    { name: 'Rice', clickMethod: homePage.gotolink.bind(homePage, "https://www.zepto.com/cn/atta-rice-oil-dals/rice-more/cid/2f7190d0-7c40-458b-b450-9a1006db3d95/scid/9798b797-0db0-4b04-b198-31b0a5849318") },
